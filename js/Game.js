class Game {
    ...
    addSprites(spriteGroup, numbreOfSprites, spriteImage, scale, positions = []){
    ...
    play() {
        ...
        if (allPlayers !== undefined) {
            ...
            for(var plr in allPlayers) {
                ...
                //agrega 1 indice para cada bucle
                index = index + 1;

                //utilizar datos de la base de datos para mostrar los autos en las direcciones x y y
    ...
    showRank() {
        swal({
            title: `Impresionante!${"\n"}Posisión${"\n"}${player.rank}`,
            text: "Llegaste a la meta con éxito :3",
            imageUrl:
                "https://raw.githubusercontent.com/vishalgaddam873/p5-multiplayer-car-race-game/master/assets/cup.png",
            imageSize:"100x100",
            confirmButtonText: "Yipee ^_^"
        })
    }
    ...
    gameOver() {
        swal({
            title: `Fin del juego`,
            text: "Perdiste la carrera :c",
            imageUrl:
                "https://cdn.shopify.com/s/files/1/1061/1924/products/Thumbs_Down_Sign_Emoji_Icon_ios10_grande.png",
            imageSize:"100x100",
            confirmButtonText: "Ayy :c"
        })
    }

    end() {
        console.log("Fin del juego :c")
    }
